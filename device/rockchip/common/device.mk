...
# [feature development] mspark, 24.09.03, Add prazen properites
TARGET_SYSTEM_PROP += device/rockchip/common/build/rockchip/rksdk.prop \
		      device/rockchip/rk3588/prazen_sys.prop
...
# Normal tablet, add QuickStep for normal product only.
  $(call inherit-product, $(SRC_TARGET_DIR)/product/full_base.mk)
# [feature delete] mspark, 24.10.15, Change launcher RKTvLauncher
...
# [feature modify] mspark, 24.09.13, Optimize HDMI Input mode 
...
ifeq ($(TARGET_BOARD_PLATFORM_PRODUCT),box)
  ...
  PRODUCT_COPY_FILES += \
       $(LOCAL_PATH)/bootshutdown/bootanimation.zip:/system/media/bootanimation.zip
