...
/*
 * Rockchip RK806 PMIC Power Key driver
 *
...
static int rk806_pwrkey_probe(struct platform_device *pdev)
{
	...
	pwr->name = "rk806 pwrkey";
	pwr->phys = "rk806_pwrkey/input0";
...
static struct platform_driver rk806_pwrkey_driver = {
	.probe	= rk806_pwrkey_probe,
	.driver	= {
		.name = "rk806-pwrkey",
	},
};
module_platform_driver(rk806_pwrkey_driver);

MODULE_ALIAS("platform:rk806-pwrkey");
MODULE_AUTHOR("Joseph Chen <chenjh@rock-chips.com>");
MODULE_DESCRIPTION("RK806 PMIC Power Key driver");
MODULE_LICENSE("GPL");
